	...
	<section>
		<div class="container" id="destaque-produtos-container">
			<div id="destaque-produtos">
				...
				<div class="col-sm-6 col-descrição">
			...
			<button type="button" id="btn-destaque-prev"><i class="fa fa-chevron-left"></i></button>
					<button type="button" id="btn-destaque-next"><i class="fa fa-chevron-right"></i></button>
		</div>
